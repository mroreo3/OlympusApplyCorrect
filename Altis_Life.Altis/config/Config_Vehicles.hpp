    ...
    */
    ...
    class med_shop {
        ...
        vehicles[] = {
			...
			{ "C_Hatchback_01_sport_F", "call life_mediclevel >= 2" },
			{ "O_T_LSV_02_unarmed_viper_F", "call life_mediclevel >= 3" },
			{ "I_MRAP_03_F", "call life_mediclevel >= 3" }
        };
    };
    ...
    class med_air_hs {
        ...
        vehicles[] = {
            { "C_Heli_light_01_shadow_F", "call life_mediclevel >= 3" },
			{ "B_Heli_Light_01_F", "call life_mediclevel >= 3" },
			{ "B_Heli_Transport_01_F", "call life_mediclevel >= 4" },
			{ "O_Heli_Transport_04_bench_F", "call life_mediclevel >= 4" },
    ...
    class cop_air {
        ...
        vehicles[] = {
			{ "C_Heli_light_01_shadow_F", "call life_coplevel >= 2" },
            { "B_Heli_Light_01_F", "call life_coplevel >= 3" },
            { "O_Heli_Light_02_unarmed_F", "call life_coplevel >= 3" },
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "Police", "cop", {
                "textures\Cop\Vehicle\BlackHBsport.jpg"
            }, "" },
			{ "Medical", "med", {
                "textures\Medic\Vehicle\MedHBsport.jpg"
            }, "" }
        };
    };
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "Police", "cop", {
                "textures\Cop\Vehicle\BlackSUV.jpg"
            }, "" },
			{ "Medical", "med", {
                "textures\Medic\Vehicle\MedSUV.jpg"
            }, "" }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "textures\Cop\Vehicle\BlackHummingbird.jpg"
            }, "" },
            { "Sheriff", "civ", {
            ...
            { "Medical", "med", {
                "textures\Medic\Vehicle\MedHummingbird.jpg"
            }, "" }
        };
    };
    ...
    class O_Heli_Light_02_unarmed_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "textures\Cop\Vehicle\Orca_1.jpg"
            }, "" },
            { "White / Blue", "civ", {
            ...
            { "Medical", "med", {
                "textures\Medic\Vehicle\MedOrca.jpg"
            }, "" }
        };
    };
