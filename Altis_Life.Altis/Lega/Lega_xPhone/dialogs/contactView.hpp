class Lega_xPhone_ContactView
{
    controls[] = {
        ...
        {"Lega_xPhone_ContactView_BtnCall", 210012}
    };
};
...
class Lega_xPhone_ContactView_BtnCall: XPhoneIconControlButton
{
    idc = 2401;
...
class Lega_xPhone_ContactView_BtnContacts: XPhoneIconControlButton
{
      ...
      h = 0.0176 * safezoneH;
      onButtonClick = "['Lega_xPhone_ContactsMain'] spawn Lega_fnc_changeMenu";
};
